...
std::string rigidtire_file("sedan/tire/Sedan_RigidTire.json");
std::string pac02tire_file("sedan/tire/Sedan_Pac02Tire.json");
std::string tmeasytire_file("sedan/tire/Sedan_TMeasyTire.json");
