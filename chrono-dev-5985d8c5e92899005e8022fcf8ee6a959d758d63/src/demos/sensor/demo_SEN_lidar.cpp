...
float horizontal_fov = 2 * CH_C_PI;  // 360 degrees
float vertical_fov = CH_C_PI / 6;    // 30 degrees
...
int main(int argc, char* argv[]) {
    ...
    auto lidar = chrono_types::make_shared<ChLidarSensor>(mesh_body,           // body lidar is attached to
                                                          ...
                                                          lag,                 // lag
                                                          collection_time      // collection time for the lidar
    );
    ...
    auto lidar2 = chrono_types::make_shared<ChLidarSensor>(mesh_body,           // body lidar is attached to
                                                           update_rate,         // scanning rate in Hz
                                                           offset_pose,         // offset pose
                                                           horizontal_samples,  // number of horizontal samples
                                                           vertical_samples,    // number of vertical channels
