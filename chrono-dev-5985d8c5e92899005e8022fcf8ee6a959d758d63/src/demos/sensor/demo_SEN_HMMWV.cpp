...
int cam_update_rate = 30;
int lidar_update_rate = 10;
...
float lidar_vfov = CH_C_PI / 6;  // 30 degrees
...
// Save sensor data
bool sensor_save = true;

// Visualize sensor data
bool sensor_vis = false;
...
int main(int argc, char* argv[]) {
    ...
    auto cam = chrono_types::make_shared<ChCameraSensor>(
        ...
        cam_fov, 0.02, 0);                                                   // fov, lag, exposure
    ...
    auto lidar = chrono_types::make_shared<ChLidarSensor>(
        ...
        lidar_vfov,                                                        // vertical field of view
        0.1, 0                                                             // lag, collection time
    );
