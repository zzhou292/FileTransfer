...
std::shared_ptr<ChCameraSensor> ReadCameraSensorJSON(const std::string& filename,
    ...
    auto camera = chrono_types::make_shared<ChCameraSensor>(parent, updateRate, offsetPose, w, h, hFOV, lag,
                                                            exposure_time, supersample_factor, lens_model);
    return camera;
}
...
std::shared_ptr<ChGPSSensor> ReadGPSSensorJSON(const std::string& filename, std::shared_ptr<chrono::ChBody> parent) {
    ...
    auto gps = chrono_types::make_shared<ChGPSSensor>(parent, updateRate, offsetPose, lag, collection_time,
                                                      gps_reference, noise_model);
...
std::shared_ptr<ChIMUSensor> ReadIMUSensorJSON(const std::string& filename, std::shared_ptr<chrono::ChBody> parent) {
    ...
    auto imu =
        chrono_types::make_shared<ChIMUSensor>(parent, updateRate, offsetPose, lag, collection_time, noise_model);
...
std::shared_ptr<ChLidarSensor> ReadLidarSensorJSON(const std::string& filename,
    ...
    auto lidar =
        chrono_types::make_shared<ChLidarSensor>(parent, updateRate, offsetPose, w, h, hfov, vfov, lag, exposure_time,
