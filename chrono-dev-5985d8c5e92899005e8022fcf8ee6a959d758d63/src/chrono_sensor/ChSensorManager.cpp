...
CH_SENSOR_API ChSensorManager::ChSensorManager(ChSystem* chrono_system, bool verbose, int render_ray_reflections)
    : m_verbose(verbose), m_optix_reflections(render_ray_reflections) {
