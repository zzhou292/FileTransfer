...
int main(int argc, char* argv[]) {
    ...
    paramsH->cMin = chrono::fsi::mR3(-bxDim / 2 - 10.0*initSpace0/2.0, -byDim / 2 - 1.0*initSpace0/2.0, -1.0*bzDim - 5 * initSpace0) * 10.0;
    paramsH->cMax = chrono::fsi::mR3( bxDim / 2 + 10.0*initSpace0/2.0,  byDim / 2 + 1.0*initSpace0/2.0,  2.0*bzDim + 5 * initSpace0) * 10.0;
    ...
    ChVector<> boxCenter(0.0, 0.0, fzDim / 2 + 1 * initSpace0);
