...
set(CHRONO_CXX_FLAGS "")
set(CHRONO_C_FLAGS "")

if (${CMAKE_SYSTEM_NAME} MATCHES "Windows")
  set(CHRONO_LINKER_FLAGS "")
else()
  set(CHRONO_LINKER_FLAGS "-L/lib")
endif()
...
set(CHRONO_DATA_DIR "")
set(CHRONO_VEHICLE_DATA_DIR "vehicle/")
set(CHRONO_FSI_DATA_DIR "fsi/")

set(CHRONO_SSE_FOUND "")
set(CHRONO_AVX_FOUND "")

#-------------------------------------------------------------------------------
# Local variables specifying which Chrono modules are enabled
#-------------------------------------------------------------------------------

set(Chrono_HAS_cascade )
set(Chrono_HAS_cosimulation )
set(Chrono_HAS_irrlicht )
set(Chrono_HAS_matlab )
set(Chrono_HAS_mkl )
set(Chrono_HAS_mumps )
set(Chrono_HAS_parallel )
set(Chrono_HAS_opengl )
set(Chrono_HAS_postprocess )
set(Chrono_HAS_python )
set(Chrono_HAS_vehicle )
set(Chrono_HAS_fsi )
set(Chrono_HAS_sensors )
...
foreach(COMPONENT ${Chrono_FIND_COMPONENTS})
  ...
  if(NOT Chrono_HAS_${COMPONENT_LOWER})
    ...
    elseif(${COMPONENT_UPPER} MATCHES "SENSORS")

      list(APPEND CHRONO_INCLUDE_DIRS "")
      list(APPEND CHRONO_LIB_NAMES "ChronoEngine_sensors")
      list(APPEND CHRONO_DLL_NAMES "ChronoEngine_sensors.dll")
      list(APPEND CHRONO_LIBRARIES "")
