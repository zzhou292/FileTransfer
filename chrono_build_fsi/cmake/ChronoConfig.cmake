...
set(CHRONO_DATA_DIR "/home/jason/Desktop/FileTransfer/FileTransfer/chrono-dev-sandbox-fsi-I2SPH-granular/data/")
set(CHRONO_VEHICLE_DATA_DIR "/home/jason/Desktop/FileTransfer/FileTransfer/chrono-dev-sandbox-fsi-I2SPH-granular/data/vehicle/")
set(CHRONO_FSI_DATA_DIR "/home/jason/Desktop/FileTransfer/FileTransfer/chrono-dev-sandbox-fsi-I2SPH-granular/data/fsi/")
...
set(Chrono_HAS_fsi ON)
set(Chrono_HAS_granular ON)
...
foreach(COMPONENT ${Chrono_FIND_COMPONENTS})
  ...
  if(NOT Chrono_HAS_${COMPONENT_LOWER})
    ...
    elseif(${COMPONENT_UPPER} MATCHES "FSI")
      ...
      list(APPEND CHRONO_INCLUDE_DIRS "/opt/cuda/include")
...
foreach(lib ${CHRONO_LIB_NAMES})
  ...
  find_library(onelib ${lib}
    PATHS "/home/jason/Desktop/FileTransfer/FileTransfer/chrono_build_fsi/lib"
...
if(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
  ...
  foreach(dll ${CHRONO_DLL_NAMES})
    ...
    find_file(onedll ${dll}
      PATHS "/home/jason/Desktop/FileTransfer/FileTransfer/chrono_build_fsi/bin"
      PATH_SUFFIXES "Release"
      NO_DEFAULT_PATH
    )
    if(NOT onedll)
