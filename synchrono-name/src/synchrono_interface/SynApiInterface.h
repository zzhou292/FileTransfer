...
#ifndef SYN_API_INTERFACE_H
#define SYN_API_INTERFACE_H

#include "chrono/ChVersion.h"
#include "chrono/core/ChPlatform.h"

// When compiling the Chrono models libraries, remember to define CH_API_COMPILE_MODELS
// (so that the symbols with 'SYN_MODELS_API' in front of them will be marked as
...
#define SYN_INTERFACE_API ChApiEXPORT
#else
#define SYN_INTERFACE_API ChApiIMPORT
#endif
