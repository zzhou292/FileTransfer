...
int main(int argc, char* argv[]) {
    ...
    if (rank != 0) {
        ...
        //cout flag 1
        if(rank==0)
        {std::cout<< "This is flag 1 rank 0" << std::endl;}
        else if (rank == 1)
        {std::cout<< "This is flag 1 rank 1" << std::endl;}
        else if (rank == 2)
        {std::cout<< "This is flag 1 rank 2" << std::endl;}
        else if (rank == 3)
        {std::cout<< "This is flag 1 rank 3" << std::endl;}
